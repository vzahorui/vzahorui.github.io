...
Let's recall that in rectangular triangle cosine of an angle is the ratio between the adjacent side and the hypotenuse. Therefore, $||a_{1}||$, 

known as scalar projection, can be expressed as $||a|| \cos{\alpha}$, 
